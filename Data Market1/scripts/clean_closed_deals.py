#!/usr/bin/env python3
"""
Clean Closed Deals Dataset

This script applies minimal cleaning rules to the closed deals dataset:
...
def main():
    ...
    input_file = "data/olist_closed_deals_dataset.csv"
    output_file = "data/clean/closed_deals_clean.csv"
    ...
    clean_closed_deals_data(input_file, output_file)
